...
export function StaffDashboard() {
  ...
  return <main className="doctor-page"><div className="doctor-page-heading"><div><p className="doctor-kicker">Staff dashboard</p><h1>Welcome, {staff.name}</h1></div></div><p>{staff.hospitalPosting}</p>
